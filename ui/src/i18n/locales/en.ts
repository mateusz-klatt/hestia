...
const en = {
  ...
  "user.passwordMismatch": "Passwords don't match",
  ...
  "wholeHome.menu": "Whole-home setup",
  "wholeHome.title": "Whole-home “all”",
  "wholeHome.desc": "Pick which devices the “all lights / all blinds” buttons act on. Unchecked devices (e.g. a nightlight) are left alone.",
  ...
  "users.addedOk": "✓ User added",
  "users.empty": "Could not load users",
  ...
  "audit.action.password": "Password changed",
  "audit.action.user_add": "User added",
  "audit.action.user_role": "Role changed",
  "audit.action.user_enable": "User enabled",
  "audit.action.user_disable": "User disabled",
  "audit.action.user_password": "Password reset",
  ...
  "rule.addWindow": "+ active window",
  "rule.addAction": "+ action",
  "rule.buildJson": "Build JSON",
  "rule.remove": "remove",
  "rule.built": "built — review then \"Save rule\"",
  "rule.loadedToForm": "✓ loaded into the wizard",
  "rule.cantReconstruct": "The wizard can't represent this rule ({what}) — edit the JSON below",
  "rule.rcId": "the rule id",
